(function () {
  ...
  const exhibitionCompanies = [
    ...
    { id: 'hyuple-exhibit', name: '휴플', field: '관광 / 테크', note: '여행플랫폼 젠트립, AI 여행추천 젠톡, 무장애 관광 나드리 운영' },
    { id: 'grime-exhibit', name: '그리메', field: '애니 / 캐릭터', note: '자체 캐릭터 IP와 2D 애니메이션, 라이선싱, 웹툰 사업 확장' },
    { id: 'k-company-exhibit', name: '케이컴퍼니', field: 'AI 콘텐츠', note: '생성형 AI 기반 영상, 디지털 콘텐츠 제작 및 AI 콘텐츠 마케팅' },
    { id: 'freeidea-exhibit', name: '프리아이디어', field: 'AI&관광, ESG', note: 'AIoT 스마트 어메니티와 호텔 데이터 SaaS 기반 호스피탈리티 테크' },
    { id: 'sai-exhibit', name: '사이', field: '식품', note: '제주 로컬 원료 블렌딩티 체험과 감정 기록 콘텐츠 프로그램' },
  ...
  window.JGCF = {
    ...
    faqs: [
      {
        q: '행사 참가 신청은 어떻게 진행되나요?',
        a: '행사 참가신청과 비즈밋업 참가신청을 별도로 운영합니다. 행사 참가신청은 구분(기업, 일반, 학생), 이름 또는 소속 정보, 연락처, 개인정보 제공 동의 항목으로 구성됩니다.'
      },
      {
        q: '비즈밋업 예약은 어떤 방식으로 진행되나요?',
        a: '신청 기업이 희망 상담기관과 시간을 선택해 예약합니다. 상담은 30분 단위로 진행되며, 이미 예약된 상담기관의 동일 시간대는 선택할 수 없습니다. 한 담당자가 여러 상담기관을 예약할 수 있고, 같은 시간에 두 곳이나 같은 기관을 두 번 예약하는 것만 제한됩니다. 예약 완료 후 "다른 기관도 예약하기"로 정보를 다시 입력하지 않고 이어서 예약할 수 있습니다.'
      },
      {
        q: '비즈밋업 신청 시 어떤 자료가 필요한가요?',
        a: '신청 기업명, 담당자 이름, 연락처, 메일 주소, 회사 소개서 PDF(20MB 이하), 상담 신청 내용(3줄 이내)을 입력합니다.'
      },
      {
    ...
    schedule: [
      ...
      },
      {
        ...
        title: '라이징 IR 피칭',
        sessions: [
          { time: '13:30 - 14:30', title: '제주지역인적자원개발위원회 추천 창업 3년 미만 기업 5개사 피칭', meta: '사이, 계란바구니, 낭만지구인, 귤바티, 해우 / VC·AC 참여' }
        ]
      },
      {
        id: 'opening',
