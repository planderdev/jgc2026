...
:::info 행사 참가신청은 메일이 나가지 않습니다
참가신청 폼은 이메일을 받지 않고 이름·연락처만 받습니다. 보낼 주소가 없어 확인 메일 대상이 아닙니다. 필요하면 폼에 메일 칸을 추가하고 개인정보처리방침의 수집 항목도 함께 고쳐야 합니다.
:::
...
1. **쌓기** — 예약이 확정·취소되면 DB 트리거가 보낼 메일을 대기열에 넣습니다
